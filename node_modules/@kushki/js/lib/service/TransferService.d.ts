...
import { ITransferService } from "./../../lib/repository/ITransferService";
 ...
 * Implementation
 */
export declare class TransferService implements ITransferService {
    private readonly _gateway;
    private readonly _antiFraud;
    constructor(gateway: IKushkiGateway, antiFraud: IAntiFraud);
    requestTransferToken(request: TransferTokenRequest, mid: string, isTest: boolean, regional: boolean): Observable<TokenResponse>;
