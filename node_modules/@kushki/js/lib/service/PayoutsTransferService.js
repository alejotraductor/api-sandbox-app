 ...
 * Implementation
 */
var PayoutsTransferService = /** @class */ (function () {
    function PayoutsTransferService(antiFraud, gateway) {
        this._kushkiGateway = gateway;
        this._antiFraud = antiFraud;
    }
    PayoutsTransferService.prototype.requestPayoutsTransferToken = function (body, mid, isTest, regional) {
        return this._kushkiGateway.requestPayoutsTransferToken(body, mid, isTest, regional);
    };
    PayoutsTransferService.prototype.requestPayoutsTransferBankList = function (mid, isTest, regional) {
