...
export declare class KushkiGateway implements IKushkiGateway {
    ...
    private _uatUrl;
    private _prodUrl;
    request<T = object>(body: object, mid: string, path: string, testEnv: boolean, regional: boolean): Observable<T>;
    requestGet<T = object>(path: string, testEnv: boolean, regional: boolean, mid?: string): Observable<T>;
